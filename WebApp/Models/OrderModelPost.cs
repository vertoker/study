...
{
    public class OrderModelPost// Для запроса ОТПРАВКИ
    {
        ...
        public OrderModelPost(int[] products_id, int[] products_count, string address, string description, int user_id, OrderStatus status)
        {
